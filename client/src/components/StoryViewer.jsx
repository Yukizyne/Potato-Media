        ...
        case 'text':
          return (
            <div className="w-full h-full flex items-center justify-center p-8 text-white text-2xl text-center">
              {viewStory.content || "No story text"}
            </div>
        );
    
      default:
        return (
          <div className="w-full h-full flex items-center justify-center p-8 text-white text-lg text-center">
            {viewStory.content || "Unsupported story content"}
          </div>
        );
    }
  }
