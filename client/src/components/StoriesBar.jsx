...
const StoriesBar = () => {
  ...
  return (
    <div className="w-full sm:w-[calc(100vw-240px)] lg:max-w-2xl overflow-x-auto no-scrollbar">
      <div className="flex items-stretch gap-4 pb-5">
          {/* Add Story Card */}
          ...
          {/* StoryCards */}
            {
              stories.map((story, index) => (
                <div onClick={()=>setViewStory(story)} key={index} className={`relative rounded-lg shadow h-40 min-w-[120px] max-w-[120px] cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95`}>
