      ...
      <div className="flex flex-col md:flex-row items-start gap-6">
          ...
          <div className="w-full pt-16 md:pt-0 md:pl-36">
              ...
              <div className="flex items-center gap-6 mt:-6 border-t border-gray-200 pt-4">
                <div>
                  <span className="sm:text-sl font-bold text-gray-900">{posts.length}</span>
                  <span className="text-xs sm:text-sm text-gray-500 ml-1.5">Post</span>
                </div>
                <div>
                  <span className="sm:text-sl font-bold text-gray-900">{user.followers.length}</span>
                  <span className="text-xs sm:text-sm text-gray-500 ml-1.5">Followers</span>
                </div>
                <div>
                  <span className="sm:text-sl font-bold text-gray-900">{user.following.length}</span>
